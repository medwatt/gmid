...
class Circuit(CircuitModel):
    ...
    def solve_point(self, v: State, dev, cond) -> State:
        ...
        M1b = dev.pmos(gmid=v.M1a_GMID, L=v.M1a_L, vds=v.M1b_VDS, vsb=0.0)
    ...
    def specs(self, b, cond) -> dict:
        ...
        out["Area"] = Area
        Itotal = b.ID["M1a"] + b.ID["M1b"] + b.ID["M5"]
        out["Itotal"] = Itotal
        VBP = b.VDD - b.M3.vgs
        out["VBP"] = VBP
        VOUT_MAX = -b.M5.vdsat + b.VDD
        out["VOUT_MAX"] = VOUT_MAX
        VOUT_MIN = b.M4.vdsat
        out["VOUT_MIN"] = VOUT_MIN
        VIN_MAX = -b.M1b.vgs - b.M3.vdsat + b.VDD
        out["VIN_MAX"] = VIN_MAX
        VIN_MIN = max(
